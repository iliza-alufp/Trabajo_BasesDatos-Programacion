...
INSERT INTO personajes (id_personaje, nombre, vida, ataque, coste, id_clase, id_objeto) VALUES
(9, 'Donkey_Kong', 6, 7, 7, 15, null),
(10, 'Diddy_Kong', 3, 4, 3, 15, null),
(11, 'Dixie_Kong', 4, 3, 3, 15, null),
(12, 'Cranky_Kong', 3, 2, 3, 15, null);

-- Elementos de la tabla personajes Toad
INSERT INTO personajes (id_personaje, nombre, vida, ataque, coste, id_clase, id_objeto) VALUES
(13, 'Toad', 2, 1, 1, 4, null),
(14, 'Toadette', 4, 3, 3, 4, null),
(15, 'Maestro_Kinopio', 3, 3, 3, 4, null),
(16, 'Capitan_Toad', 4, 4, 3, 4, null);

-- Elementos de la tabla personajes Koopa
INSERT INTO personajes (id_personaje, nombre, vida, ataque, coste, id_clase, id_objeto) VALUES
(17, 'Koopa_Troopa', 2, 1, 1, 2, null),
(18, 'Koopa_Paratroopa', 3, 1, 1, 2, null),
(19, 'Huesitos', 1, 1, 3, 2, null),
(20, 'Hammer_Bro', 3, 4, 3, 2, null),
(21, 'Lakitu', 3, 2, 4, 2, null),
(22, 'Pinchon', 1, 3, 2, 2, null),
(23, 'Buzzy_Beetle', 4, 1, 2, 2, null),
...
(33, 'Boom_Boom', 3, 4, 3,2, null),
(34, 'Pom_Pom', 4, 3, 3,2, null),
...
INSERT INTO personajes (id_personaje, nombre, vida, ataque, coste, id_clase, id_objeto) VALUES
(54, 'Boo', 4, 1, 2, 6, null),
(55, 'Rey_Boo', 7, 8, 6, 6, null),
(56, 'Lady_Bow', 3, 4, 3, 6, null),
(57, 'Claudia', 5, 3, 3, 6, null),
(58, 'Bibiana', 4, 5, 3, 6, null),
(59, 'Boo_Bomba', 2, 1, 3, 6, null),
(60, 'Reina_Sombras', 9, 6, 7, 6, null),
...
(1, "Champinyon", 3, 1, "Aumenta la vitalidad de todo aquel que lo consuma"),
(2, "Flor_de_Fuego", 3, 2, "Aumenta el ataque del poseedor"),
...
(8, "Bill_Bala", 2, 8, "Misil que daña al enemigo"),
(9, "Bill_Banzai", 4, 9, "Gran misil de daño masivo"),
(10, "Veneno", 2, 10, "Champiñón venenoso reutilizable"),
(11, "Vida_Extra", 5, 11, "Champiñón con poderes curativos milagrosos"),
(12, "Duplicereza", 7, 12, "Todo aquel que lo consuma vivrá su mejor estado de forma"),
(13, "Campana", 4, 13, "Extraña campana de aura gatuna");
...
CREATE PROCEDURE modificar_usuario(IN nombreActual VARCHAR(30), IN p_contrasenya VARCHAR(20), IN nuevoNombre VARCHAR(30))

  BEGIN
    UPDATE usuarios
    SET nombre = nuevoNombre
    WHERE nombreActual = nombre AND p_contrasenya = contrasenya;
  END //
...
DELIMITER //
DROP PROCEDURE IF EXISTS buscar_carta //
